...
import com.mealmate.mealmate.adapter.MealPlanGridAdapter;
import com.mealmate.mealmate.data.model.MealData;
import com.mealmate.mealmate.databinding.FragmentMealPlanBinding;
...
public class MealPlanFragment extends Fragment {
    ...
    public void getMeals() {
        ...
        adapter = new MealPlanGridAdapter();
        binding.mealPlansRv.setAdapter(adapter);
        binding.mealPlansRv.setLayoutManager(new StaggeredGridLayoutManager(2, GridLayoutManager.VERTICAL));
        adapter.dataList = mealDataList;

        CollectionReference docRef = firestore.collection("my_meal_plans").document(user.getUid()).collection("my_meals");
